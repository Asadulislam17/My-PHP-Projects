...
<aside class="admin-sidebar" id="adminSidebar" aria-label="Main navigation">
    ...
    <nav class="sidebar-nav">
        ...
        <a class="nav-link @if (Route::is('students.*')) active @endif" href="{{ route('students.index') }}">
            <span class="nav-icon"><i class="bi bi-people" aria-hidden="true"></i></span>
            <span class="nav-text">Students</span>
        </a>

        
        <a class="nav-link @if (Route::is('districts.*')) active @endif" href="{{ route('districts.index') }}">
            <span class="nav-icon"><i class="bi bi-geo-alt" aria-hidden="true"></i></span>
            <span class="nav-text">Districts</span>
        </a>

       
        <a class="nav-link @if (Route::is('subjects.*')) active @endif" href="{{ route('subjects.index') }}">
